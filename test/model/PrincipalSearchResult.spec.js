...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synactaclientjs.PrincipalSearchResult();
  });
  ...
  describe('PrincipalSearchResult', function() {
    it('should create an instance of PrincipalSearchResult', function() {
      // uncomment below and update the code to test PrincipalSearchResult
      //var instane = new Synactaclientjs.PrincipalSearchResult();
      //expect(instance).to.be.a(Synactaclientjs.PrincipalSearchResult);
    });
